...
export default defineConfig({
	...
	optimizeDeps: {
		...
		// include: ['axios'],
		include: ['esm-dep > cjs-dep', 'axios', 'lodash-es', 'dayjs', 'vue', 'vue-router'],
	...
	css: {
		...
		preprocessorOptions: {
			...
			scss: {
				...
				/** 引入var.scss全局预定义变量 */
				additionalData:
					'@import "@/assets/styles/main/normalize.scss"; import "@/assets/styles/main/base.scss"; import "@/assets/styles/main/function.scss";',
			},
		},
		// postCss 配置
		postcss: {
	...
	build: {
		...
		//指定输出路径
		// outDir: `./dist_${env.VITE_NODE_ENV}`,
		// 指定生成静态资源的存放路径
		assetsDir: 'static',
		//启用/禁用 CSS 代码拆分
		cssCodeSplit: true,
