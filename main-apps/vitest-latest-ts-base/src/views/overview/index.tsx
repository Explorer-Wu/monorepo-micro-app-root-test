...
export default function OverView() {
	...
	const [reqProps, setReqProps] = useState<OverviewData | null>(null);
	...
	async function loadDataFn() {
		try {
			...
			console.error('overview loadDataFn error:', error);
		}
	}

	return (
		<div className="view-con" data-screen-fit="contain">
			<LocalMap />
			...
			<div className="vs-right">
				...
				<div className="db-right-bottom">
					<BoxCard
						...
						SlotCon={() =>
							reqProps ? (
								<TeamsMsgList propTeams={reqProps.teamsData as any} />
							) : null
						}
					/>
					<BoxCard
						...
						SlotCon={() =>
							reqProps ? (
								<ActiveApps propActives={reqProps.activitiesData as any} />
							) : null
						}
					/>
				</div>
