import OnlineBdMap from '@/components/Maps';
...
export default function LocalMap() {
	...
	const styleJson: Record<string, unknown>[] = [
		...
		{ featureType: 'building', elementType: 'geometry.fill', stylers: { color: '#ffffffb3' } },
		{ featureType: 'building', elementType: 'geometry.stroke', stylers: { color: '#dadadab3' } },
		{ featureType: 'subwaystation', elementType: 'geometry', stylers: { visibility: 'on', color: '#b15454B2' } },
		{ featureType: 'education', elementType: 'geometry', stylers: { visibility: 'on', color: '#e4f1f1ff' } },
		{ featureType: 'medical', elementType: 'geometry', stylers: { visibility: 'on', color: '#f0dedeff' } },
		{ featureType: 'scenicspots', elementType: 'geometry', stylers: { visibility: 'on', color: '#e2efe5ff' } },
		{ featureType: 'highway', elementType: 'geometry', stylers: { visibility: 'on', weight: 4 } },
		{ featureType: 'highway', elementType: 'geometry.fill', stylers: { color: '#f7c54dff' } },
		{ featureType: 'highway', elementType: 'geometry.stroke', stylers: { color: '#fed669ff' } },
		{ featureType: 'highway', elementType: 'labels', stylers: { visibility: 'on' } },
		{ featureType: 'highway', elementType: 'labels.text.fill', stylers: { color: '#8f5a33ff' } },
		...
		{ featureType: 'arterial', elementType: 'geometry.fill', stylers: { color: '#d8d8d8ff' } },
		{ featureType: 'arterial', elementType: 'geometry.stroke', stylers: { color: '#ffeebbff' } },
		{ featureType: 'arterial', elementType: 'labels', stylers: { visibility: 'on' } },
		{ featureType: 'arterial', elementType: 'labels.text.fill', stylers: { color: '#525355ff' } },
		...
		{ featureType: 'local', elementType: 'geometry.fill', stylers: { color: '#d8d8d8ff' } },
		{ featureType: 'local', elementType: 'geometry.stroke', stylers: { color: '#ffffffff' } },
		...
		{ featureType: 'railway', elementType: 'geometry', stylers: { visibility: 'on', weight: 1 } },
		{ featureType: 'railway', elementType: 'geometry.fill', stylers: { color: '#123c52ff' } },
		{ featureType: 'railway', elementType: 'geometry.stroke', stylers: { color: '#12223dff' } },
		{ featureType: 'subway', elementType: 'geometry', stylers: { visibility: 'on', weight: 1 } },
		...
		{ featureType: 'continent', elementType: 'labels.text.stroke', stylers: { color: '#ffffffff' } },
		...
		{ featureType: 'districtlabel', elementType: 'labels.text.stroke', stylers: { color: '#ffffffff' } },
		{ featureType: 'entertainment', elementType: 'geometry', stylers: { color: '#ffffffff' } },
		{ featureType: 'shopping', elementType: 'geometry', stylers: { color: '#12223dff' } },
	];

	return <OnlineBdMap mapStyle={styleJson} mapParam={mapInfo} />;
}
